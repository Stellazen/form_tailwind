    ...
    return(
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            <div className="flex flex-col">
                ...
                <input type="text" id="" placeholder="Digite seu nome" className="rounded-lg py-2 px-2 text-sm placeholder:text-sm placeholder:text-stone-400"
                value={name}
            ...
            <div className="flex flex-col">
                ...
                <input type="email" id="" placeholder="Insira seu melhor email"className="rounded-lg py-2 px-2 text-sm placeholder:text-sm placeholder:text-stone-400" 
                value={email}
